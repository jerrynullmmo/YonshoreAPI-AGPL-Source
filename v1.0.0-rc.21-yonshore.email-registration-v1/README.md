...
本源码对应的固定 `linux/amd64` 镜像 ID 为：

`sha256:829dc179d148e816a10a3abe6c470c2da1005a815aa662c566a2e03c5802019d`

镜像归档和 SBOM 的校验和记录在 `SOURCE-MAP.json`。该映射证明源码与待部署
制品的关系；是否已经部署以及更完整的运营状态仍以 YonshoreAPI 当次生产证据为准。
